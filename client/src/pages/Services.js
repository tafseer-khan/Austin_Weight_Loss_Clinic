        ...
        <div class="servicesBG">
            ...
            <div id="cc"class="card">
                <div class="card-body">
                    ...
                    <ul>
                        <li>
                            HCG with low calorie diet plan
                        <ul>
                            <li>
                    ...
                    We also have a selection of some oral vitamin/mineral supplements, fiber supplements, shakes, and bars for your convenience (optional).
                </div>
